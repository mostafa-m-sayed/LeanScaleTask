...
import UIKit
protocol DescriptionStatus: AnyObject {
    func DescriptionExpanded()
}
class GameDetailsTableCell: UITableViewCell {
    ...
    weak var delegate: DescriptionStatus?
